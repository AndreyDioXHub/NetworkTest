...
namespace Fragsurf.Movement {
    public class SurfController {
            ...
            switch (_surfer.moveType) {
                ...
                if (_surfer.groundObject == null) {
                    ...
                    */
                    ...
                    float speed = _surfer.moveData.sprinting ? _config.sprintSpeed * Model.Instance.Speed.Value : _config.walkSpeed * Model.Instance.Speed.Value;
                    if (crouching)
                        speed = _config.crouchSpeed * Model.Instance.Speed.Value;
        ...
        private Vector3 AirInputMovement () {
            ...
            if (_config.clampAirSpeed && (wishSpeed != 0f && (wishSpeed > _config.maxSpeed * Model.Instance.Speed.Value))) {

                wishVel = wishVel * (_config.maxSpeed * Model.Instance.Speed.Value / wishSpeed);
                wishSpeed = _config.maxSpeed * Model.Instance.Speed.Value;
